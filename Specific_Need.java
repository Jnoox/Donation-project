...
public class Specific_Need {
    private  String name,description,address,id = null;
    private  int number;
    
    public Specific_Need(String name, String description, String address, String id,int number){
        this.name = name;
    ...
    public String specificNeed(String name, String description, String address, String id,int number){
        String ListOfNeeds;
